...
<body>
  ...
  <h1 class="heading" style="margin:50px 0 70px 600px ;">My Approved Books</h1>
...
error_reporting(0);
      ...
      include "connection.php";
        ...
        $sql = "SELECT * FROM my_orders WHERE s_sbrn='$sbrn' AND order_status=1";
      ...
      {
        echo "<h1 style='margin: 100px 0 0 450px'>"."<strong>Sorry! </strong>You Didn't Have Any approved Book."."</h1>". mysqli_error($con);
      }
