  ...
  if (isset($_POST['submit']))
  {
    ...
    $dob= $_POST['dob'];
        ...
        if(ctype_alpha($sname) AND ctype_alpha($fname) AND is_numeric($sbrn) AND is_numeric($phone) AND mb_strlen($phone)==10 AND is_numeric($sbrn) AND mb_strlen($sbrn)==12)
        {
              ...
              $sql4="INSERT INTO student(uname, pass) values('$sbrn', '$sname')";

              $result4=mysqli_query($con, $sql4);

              $sucess_msg="Student Registered & Login Credentials Generated <strong>Successfully!!</strong>";  
        }       

        else
        {
            $warn_msg="<strong>Warning!!</strong> Please Enter Valid Student Details.";               
        }
}
      ...
      <form action="#" method="POST">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" name="sbrn" placeholder="Enter Board Roll No." maxlength="12" required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" name="phone" placeholder="Enter Mobile Number" maxlength="10" required>
          </div>
          <div class="input-box">
