<?php
	...
	$sql7= "SELECT issued_id FROM issued_books WHERE book_id='$b_id' AND student_id='$s_id' AND return_flag=0";
	  $result7= mysqli_query($con, $sql7);
	 if(mysqli_num_rows($result7)>0)
	  {
	  	$msg="<strong> Warning!! </strong>This Book Is Already Issued To This Student And Not Returned Yet. ";
	    header("Location: issue_book_to_student.php? msg=$msg");
	  } 
	  else
	  {
				...
				if(mysqli_num_rows($result3) > 0)
				{
					while($row3 = mysqli_fetch_assoc($result3))
					{
						...
						else
						{
							...
							$sql="INSERT INTO issued_books(book_id, student_id, issued_for, return_date, return_flag) VALUES ('$b_id', '$s_id', '$issued_for', '$date', 0)";
							...
							$result=mysqli_query($con, $sql);
								...
								echo "<script>window.location.href= 'return_student.php? msg=$msg'</script>";
						}
					}
				}
			}
