...
<?php include "menu_bar.php"; ?>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    #main .tb{height:28px; text-align: left; width:50%; border:1px solid #f26724; color:#fd7838; font-weight:bold; border-left:5px solid #f7f7f7; opacity:0.9;}
    ...
    <input list="browsers1" placeholder="Enter Semester here" name="browser" id="browser" class="tb">  <br> <br>
    ...
    <input list="browsers2" placeholder="Enter Branch here" name="browser" id="browser" class="tb">  <br> <br>
   ...
   <label><b> Address </b> </label> <br>
    ...
    <input type="submit" id="b1" value="Register" class="btn" onclick="registration()" />
