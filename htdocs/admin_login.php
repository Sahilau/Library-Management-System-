...
<ul class="nav-area">
<li><a href="/student/welcome.php">Home</a></li>
<li><a href="/student/student_login.php">User Login</a></li>
            ...
            <div class="col-lg-6 col-md-8 login-box">
                ...
                <?php 
                        ...
                        if(isset($_POST['submit']))
                        {
                            ...
                            $sql="SELECT uname, pass from admin where uname='$uname' and pass='$password'";
