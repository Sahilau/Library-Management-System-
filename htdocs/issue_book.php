      ...
      include "connection.php";
        ...
        if (mysqli_num_rows($result) > 0) 
        {
         ...
         
         {
          ...
          echo "<td>"."<a class='delete' href='issue_book_to_student.php?b_id=$row[id]& b_title=$row[title]& b_writer=$row[writer]& b_publisher=$row[publisher]& b_price=$row[price]& b_available=$row[available]'>".'Issue'."</a>"."</td>";
          echo "</tr>"; 
